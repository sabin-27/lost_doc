...
// Check if the user is NOT logged in. If not, redirect them to the Admin Login page.
...
<body>
    ...
    <div class="container my-5">
        <h2 class="mb-4 text-center text-success">🔎 Track Lost and Found Documents</h2>
...
echo '<td>
        ...
        // ONLY show Edit and Delete buttons if $_SESSION["loggedin"] is true
        if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
            echo '<a href="edit.php?id=' . $row['id'] . '" class="btn btn-sm btn-warning me-1">Edit</a>
